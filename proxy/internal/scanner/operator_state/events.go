...
// PrevHash/EntryHash are v2 contract fields; empty in v1 logs and passed to
// the (no-op) HashChainVerifier on ingest for forward compatibility.
type DecisionEvent struct {
	...
	PrevHash  string `json:"prev_hash,omitempty"`  // v2: SHA-256 of previous entry
	EntryHash string `json:"entry_hash,omitempty"` // v2: SHA-256 of this entry
}
